...
describe('features/EditableProfileCard', () => {
    ...
    test('Should the values be reset to zero when canceled', async () => {
        ...
        expect(screen.getByTestId('ProfileCard.firstname')).toHaveValue(profile.username);
        expect(screen.getByTestId('ProfileCard.lastname')).toHaveValue(profile.lastname);
        expect(screen.getByTestId('ProfileCard.age')).toHaveValue(`${profile.age}`);
        expect(screen.getByTestId('ProfileCard.city')).toHaveValue(profile.city);
        expect(screen.getByTestId('ProfileCard.username')).toHaveValue(profile.username);
        expect(screen.getByTestId('ProfileCard.avatar')).toHaveValue(profile.avatar);
    });
